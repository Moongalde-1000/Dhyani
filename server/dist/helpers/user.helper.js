...
exports.editUserValidation = exports.addUserValidation = exports.changePaswordValidation = void 0;
...
exports.addUserValidation = zod_1.z.object({
    ...
    role: zod_1.z.enum(["DEFAULT", "ADMIN"]).optional(),
});
